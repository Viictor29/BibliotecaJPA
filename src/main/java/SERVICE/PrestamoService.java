...
public class PrestamoService {
    ...
    List<Prestamo> listaPrestamosMemoria = new ArrayList<Prestamo>();
    ...
    public void sincronizar() {
        listaPrestamosMemoria = prestamoDAO.listarPrestamos();
    }
    ...
    public void registrarPrestamoMemoria() {
        ...
        long prestamosActivos = listaPrestamosMemoria.stream()
